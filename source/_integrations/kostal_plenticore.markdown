...
The `kostal_plenticore` integration allows you to get data from [Kostal Plenticore](https://www.kostal-solar-electric.com/) solar inverters and integrate them into your Home Assistant installation.
...
| Home Power form Own     | W    | Power used for home consumption from own production. |
